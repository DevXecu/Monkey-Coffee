...
('18.234.567-9', 'Maria', 'Gonzalez Perez', 'maria.gonzalez@monkeycoffee.cl', '+56912345678', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '1990-05-15', 'Av. Arturo Prat 1234, Iquique', 'Gerente General', 'Administracion', '2023-01-15', 850000, 'indefinido', 'activo', 1),
('19.345.678-2', 'Carlos', 'Ramirez Silva', 'carlos.ramirez@monkeycoffee.cl', '+56923456789', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '1992-08-22', 'Calle Baquedano 567, Iquique', 'Barista Senior', 'Operaciones', '2023-02-01', 550000, 'indefinido', 'activo', 1),
('20.456.789-1', 'Fernanda', 'Torres Morales', 'fernanda.torres@monkeycoffee.cl', '+56934567890', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '1995-11-10', 'Av. Heroes de la Concepcion 890, Alto Hospicio', 'Barista', 'Operaciones', '2023-03-10', 450000, 'indefinido', 'activo', 1),
('17.567.890-5', 'Diego', 'Vargas Castro', 'diego.vargas@monkeycoffee.cl', '+56945678901', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '1993-03-28', 'Pasaje Los Carrera 234, Iquique', 'Cajero', 'Ventas', '2023-04-05', 420000, 'indefinido', 'activo', 1),
('18.678.901-6', 'Camila', 'Herrera Rojas', 'camila.herrera@monkeycoffee.cl', '+56956789012', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '1996-07-14', 'Av. La Tirana 1456, Alto Hospicio', 'Barista', 'Operaciones', '2023-05-20', 450000, 'indefinido', 'activo', 1),
('19.789.012-6', 'Sebastian', 'Mendoza Lopez', 'sebastian.mendoza@monkeycoffee.cl', '+56967890123', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '1991-12-05', 'Calle Sargento Aldea 789, Iquique', 'Supervisor de Turno', 'Operaciones', '2023-01-20', 600000, 'indefinido', 'activo', 1),
('20.890.123-0', 'Valentina', 'Castro Diaz', 'valentina.castro@monkeycoffee.cl', '+56978901234', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '1994-09-18', 'Av. Esmeralda 321, Iquique', 'Cajera', 'Ventas', '2023-06-01', 420000, 'indefinido', 'activo', 1),
('17.901.234-0', 'Nicolas', 'Jimenez Flores', 'nicolas.jimenez@monkeycoffee.cl', '+56989012345', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '1997-02-25', 'Calle OHiggins 654, Alto Hospicio', 'Barista', 'Operaciones', '2023-07-15', 450000, 'indefinido', 'activo', 1),
('18.012.345-8', 'Javiera', 'Soto Martinez', 'javiera.soto@monkeycoffee.cl', '+56990123456', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '1998-06-30', 'Av. Los Rieles 987, Alto Hospicio', 'Auxiliar de Cocina', 'Operaciones', '2023-08-10', 380000, 'indefinido', 'activo', 1),
('19.123.456-1', 'Andres', 'Contreras Vega', 'andres.contreras@monkeycoffee.cl', '+56901234567', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '1992-10-12', 'Calle Thompson 456, Iquique', 'Encargado de Inventario', 'Logistica', '2023-02-15', 520000, 'indefinido', 'activo', 1),
('21.234.567-9', 'Sofia', 'Munoz Ortiz', 'sofia.munoz@monkeycoffee.cl', '+56912345679', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '1999-04-12', 'Av. Tarapaca 2345, Iquique', 'Barista Junior', 'Operaciones', '2024-01-10', 420000, 'indefinido', 'activo', 1),
('16.789.012-1', 'Roberto', 'Paz Salazar', 'roberto.paz@monkeycoffee.cl', '+56923456780', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '1989-11-28', 'Calle Vivar 678, Iquique', 'Encargado de Mantencion', 'Mantencion', '2023-03-01', 480000, 'indefinido', 'activo', 1);
