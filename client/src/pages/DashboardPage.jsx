  ...
  const recentActivities = [
    {
      id: 1,
      type: 'empleado',
      message: 'Nuevo empleado registrado: Juan Pérez',
      time: 'Hace 2 horas',
      icon: '👤',
    },
    {
      id: 2,
      type: 'venta',
      message: 'Venta completada: $45.50',
      time: 'Hace 3 horas',
      icon: '💰',
    },
    {
      id: 3,
      type: 'producto',
      message: 'Producto agotado: Café Americano',
      time: 'Hace 5 horas',
      icon: '⚠️',
    },
    {
      id: 4,
      type: 'empleado',
      message: 'Empleado actualizado: María García',
      time: 'Hace 1 día',
      icon: '✏️',
    },
  ];
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <button className="p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-indigo-500 hover:bg-indigo-50 transition-colors">
                <div className="text-center">
                  ...
                  <p className="mt-2 text-sm text-gray-600">Gestionar Productos</p>
                </div>
              </button>
              <button className="p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-indigo-500 hover:bg-indigo-50 transition-colors">
                <div className="text-center">
                  ...
                  <p className="mt-2 text-sm text-gray-600">Configuración</p>
                </div>
              </button>
            </div>
          </div>
